    ...
    <script type="text/javascript">
		$(document).ready(function() {
		 ...
		 function getChart(year,month,pipeline){
		    var chart= new FusionCharts("<?php echo base_url().'Scripts/FusionCharts/MSStackedColumn2DLineDY.swf';?>","ChartId","100%","100%","0","0");	
	        chart.setDataURL("<?php echo base_url().'patientscaleup_management/plotgraph/';?>"+year+'/'+month+'/'+pipeline);
			...
			<div id="navigation">
				...
				<div id="main-nav">
					...
					<ul class="tabbed">
						...
						<li class="current-tab"><a href="<?php echo base_url() . 'patientscaleup_management';?>">Patients Scale Up Trend</a></li>
...
<div class="section-title" style="padding:2px;"> Patient Scaleup Breakdown</div>
<!---
<div id='jqxtabs'>
