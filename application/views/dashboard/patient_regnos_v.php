    ...
    <script type="text/javascript">
		$(document).ready(function() {
		 ...
		 function getChart(year,month,pipeline){
	        ...
	        chart.setDataURL("<?php echo base_url().'patientbyregimen_management/plotgraph/';?>"+year+'/'+month+'/'+pipeline);
		...
		<div id="header">
			...
			<div id="navigation">
				...
				<div id="main-nav">
					...
					<ul class="tabbed">
						<li><a href="<?php echo base_url() . 'test_management';?>">Stocks Situation</a></li>
						<li class="current-tab"><a href="<?php echo base_url() . 'patientbyregimen_management';?>">Patients on ART</a></li>
				...
				<div id="sub-nav" style="width:420px">
					...
					<ul class="tabbed" >
						<li class="current-tab" ><a href="adt_national.php">National Level</a></li>
						<li><a href="adt_facilitystatus.php">Facility Level</a></li>						
					</ul>
...
<div class="section-title" style="padding:2px;">Patient By Regimen Breakdown </div>
<!---
<div id='jqxtabs'>
